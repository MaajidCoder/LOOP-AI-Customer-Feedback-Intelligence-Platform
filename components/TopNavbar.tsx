      ...
      <div className="flex flex-1 items-center gap-4">
        ...
        <div className="hidden sm:flex max-w-md flex-1 items-center relative">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2 pl-10 pr-4 text-sm placeholder-slate-400 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
          />
        </div>
      </div>
